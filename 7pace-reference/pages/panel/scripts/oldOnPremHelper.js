...
function onPremApplyTheme(VSS){
    const rootComputedStyle = getComputedStyle(document.documentElement);
    const primaryColor = rootComputedStyle.getPropertyValue(`--${copyLightThemeData["palette-primary-darken-6"]}`);

    if (!primaryColor) {
        VSS.applyTheme(copyLightThemeData);
    }
}