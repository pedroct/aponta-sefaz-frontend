...
- **Total symbols discovered:** 333
- **Architecture layers:** Models, Utils, Controllers, Components, Repositories
- **Entry points:** client/src/components/layouts/index.ts, client/src/components/ado/index.ts, client/src/main.tsx

### Key Components
**Core Classes:**
- `ApiClientError` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/api.ts:45
- `ApiClient` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/api.ts:60

**Key Interfaces:**
- `TimesheetResponse` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/timesheet-types.ts:10
- `WorkItemTimesheet` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/timesheet-types.ts:34
- `CelulaDia` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/timesheet-types.ts:73
- `ApontamentoDia` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/timesheet-types.ts:88
- `TotalDia` — /mnt/c/Projetos/Azure/fe-aponta/client/src/lib/timesheet-types.ts:101
## Agent Lineup
