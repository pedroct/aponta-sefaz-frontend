...
## Repository map
- `7pace-reference/` — explain what lives here and when agents should edit it.
...
- `docker-compose.staging.yml/` — explain what lives here and when agents should edit it.
