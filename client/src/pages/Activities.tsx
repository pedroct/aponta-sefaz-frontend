    ...
    <div className="bg-white border-b border-[#EAEAEA] px-6 py-4 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-[#605E5C] font-semibold"><span className="text-[#201F1E]">Estimado</span> <span className="text-[#201F1E]">8 horas</span></span>
          <span className="text-[#605E5C] font-semibold"><span className="text-[#201F1E]">Executado</span> <span className="text-[#201F1E]">7 horas : 45 minutos</span></span>
        </div>
